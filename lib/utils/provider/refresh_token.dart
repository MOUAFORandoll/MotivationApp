...
class CustomDio {
  ...
  // newConnexion(connexion, token1) async {
  //   String imei = await ImeiPlugin.getImei();
  //   print(ApiUrl.baseUrl);
  //   print("Post in connexion ***$connexion********************$imei");
  //   var userData = box.read(userKey);
  //   if (userData != null && userData != []) {
  //     if (userData['token'] is String) {
  //       token = userData['token'];
  ...
  //     var payload;
  //     if (token1 == "") {
  //       payload = Jwt.parseJwt(token.toString());
  //     } else {
  //       payload = Jwt.parseJwt(token1.toString());
  //     }

  //     print("voici payload   $payload");
  ...
  //       }),
  //     ).post("/api/connexions", data: data);

  //     if (response.statusCode == 201) {
  //       //  print("nouvelle connexion ok");
  //     } else {
  //       print("errorrrrrr nouvelle connexion ok");
  //     }
  //   } else {
  //     print("nuuuuuuuuuuuuuuuuuuuuuuuuuuuuu");
  //   }
  // }
}
